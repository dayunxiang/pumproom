...
var BaiduMapObj = (function () {
    ...
    this.addOverLay = function (map,markerArr) {
        ...
        for (var i = 0; i < markerArr.length; i++) {
            ...
            var p0 = json.point.split("|")[0];
            var p1 = json.point.split("|")[1];
            var txt = "<b class='iw_poi_title' title='" + json.title + "'>" + json.title + "</b><p><span>" + json.elecname + "</span>" + json.electricity
                + "</p><p><span>" + json.watername + "</span>" + json.water + "</p><p><span>" + json.airname + "</span>" + json.air + "</p><p><span>" + json.alarmname + "</span>" + json.alarm +"</p>";
